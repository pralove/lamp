...
* $docker build -t <your_username>/myweb:1.0 .    --> Run this command to build your docker image
* $docker push <your_username>/myweb:1.0          --> Run this command to push image to your docker repository
